...
namespace WebAPI.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        {
            var result = _carService.GetCarsByDailyPrice(minPrice, maxPrice);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        {
            var result = _carService.GetCarsByModelYear(minYear, maxYear);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        [HttpGet("getdetailsbybrandidandcolorid")]
        public IActionResult GetDetailsByBrandIdAndColorId(int brandId,int colorId)
        {
